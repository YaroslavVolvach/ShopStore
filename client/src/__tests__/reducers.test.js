...
const initialState = {
  ...
  currentCategory: '1',
     // Cart UI data sample
  cart: [{_id: '1', name: 'Soup', purchaseQuantity: 1}, {_id: '2', name: 'Bread', purchaseQuantity: 2}],
  cartOpen: false,
};

test('UPDATE_PRODUCTS', () => {
  let newState = reducer(initialState, {type: UPDATE_PRODUCTS, products: [{}, {}]});
...
test('UPDATE_CATEGORIES', () => {
  let newState = reducer(initialState, {type: UPDATE_CATEGORIES, categories: [{}, {}]});
...
test('REMOVE_FROM_CART', () => {
  let newState1 = reducer(initialState, {type: REMOVE_FROM_CART, _id: '1'});
  // cart is still open
  ...
  let newState2 = reducer(newState1, {type: REMOVE_FROM_CART, _id: '2'});
...
test('UPDATE_CART_QUANTITY', () => {
  let newState = reducer(initialState, {type: UPDATE_CART_QUANTITY, _id: '1', purchaseQuantity: 3});
...
test('CLEAR_CART', () => {
  let newState = reducer(initialState, {type: CLEAR_CART});
...
test('TOGGLE_CART', () => {
  let newState = reducer(initialState, {type: TOGGLE_CART});
